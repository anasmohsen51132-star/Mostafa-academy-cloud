    ...
    >
      ...
      <div className="px-5 py-6 border-b border-gold/20">
        ...
        <div
          ...
          className="text-[10px] text-gold/40 font-semibold tracking-widest mb-1 uppercase"
        ...
        <div className="px-5 py-4 border-b border-gold/10">
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              className="text-cream/80 text-sm truncate"
          ...
          <div key={section}>
            ...
            {section !== "_" && (
              ...
              <div
                ...
                className="px-5 py-2 text-[10px] text-cream/30 tracking-widest uppercase font-semibold"
